...
const Foods= () => {
  ...
  const getTotalCost = () => {
    const totalCost = cartItems.reduce(
      (acc, item) => acc + parseFloat(item.cost.replace('$', '')) * item.quantity,0);
    ...
    <div className="food-app">
      <header >
        <h1>Welcome To VSV Foods</h1>
         <marquee direction="right" scrollamount="25%"><img src="https://e7.pngegg.com/pngimages/101/848/png-clipart-pizza-delivery-fast-food-restaurant-pizza-delivery-pizza-food-logo-thumbnail.png" alt="Foods" /> </marquee>
      </header>
      <main>
